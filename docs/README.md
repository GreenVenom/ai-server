...
- Making a technical change: architecture, related [ADRs](decisions/), the active [M09 milestone](operations/milestones/M09-Model-Lifecycle-Selection-and-Routing.md), and relevant runbooks.
...
- Reviewing planned v2 work: [roadmap](../ROADMAP.md), then the M09–M15 milestone records in [operations/milestones](operations/milestones/).
